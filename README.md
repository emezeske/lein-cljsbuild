...
* [Launching REPLs for interactive development] (https://github.com/emezeske/lein-cljsbuild/blob/0.1.6/doc/REPL.md)
...
[migration documentation] (https://github.com/emezeske/lein-cljsbuild/blob/0.1.6/doc/MIGRATING-TO-0.1.x.md)
for details.

## Just Give Me a Damned Example Already!

See the
[example-projects] (https://github.com/emezeske/lein-cljsbuild/blob/0.1.6/example-projects)
directory for a couple of simple examples of how to use lein-cljsbuild.  The
[simple project] (https://github.com/emezeske/lein-cljsbuild/blob/0.1.6/example-projects/simple)
shows a dead-simple "compile only" configuration, which is a good place to start.  The
[advanced project] (https://github.com/emezeske/lein-cljsbuild/blob/0.1.6/example-projects/advanced)
contains examples of how to use the extended features of the plugin.

Also, see the
[sample.project.clj] (https://github.com/emezeske/lein-cljsbuild/blob/0.1.6/sample.project.clj)
...
[crossovers] (https://github.com/emezeske/lein-cljsbuild/blob/0.1.6/doc/CROSSOVERS.md)
...
See the
[example-projects/advanced] (https://github.com/emezeske/lein-cljsbuild/blob/0.1.6/example-projects/advanced)
...
of ways.  See the
[REPL documentation] (https://github.com/emezeske/lein-cljsbuild/blob/0.1.6/doc/REPL.md)
for more details.

## Testing Support

Lein-cljsbuild has built-in support for running external ClojureScript test processes.  See the
[testing documentation] (https://github.com/emezeske/lein-cljsbuild/blob/0.1.6/doc/TESTING.md)
for more details.
...
[crossovers documentation] (https://github.com/emezeske/lein-cljsbuild/blob/0.1.6/doc/CROSSOVERS.md)
for more details.
