...
;;     (util/find-files cljs-path-a #{"cljc clj"}) => [] :times 1
;;     (util/find-files cljs-path-b #{"cljc clj"}) => [] :times 1
;;     (util/find-files cljs-path-a #{"cljc cljs"}) => [cljs-file-a] :times 1
;;     (util/find-files cljs-path-b #{"cljc cljs"}) => [cljs-file-b] :times 1
;;     (util/find-files cljs-checkout-path-a #{"cljc clj"}) => [] :times 1
;;     (util/find-files cljs-checkout-path-b #{"cljc clj"}) => [] :times 1
;;     (util/find-files cljs-checkout-path-a #{"cljc cljs"}) => [cljs-checkout-file-a] :times 1
;;     (util/find-files cljs-checkout-path-b #{"cljc cljs"}) => [cljs-checkout-file-b] :times 1
