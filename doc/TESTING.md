...
The
[advanced example project] (https://github.com/emezeske/lein-cljsbuild/blob/0.1.3/example-projects/advanced)
...
2. A
[static HTML page] (https://github.com/emezeske/lein-cljsbuild/blob/0.1.3/example-projects/advanced/resources/private/html/unit-test.html)
...
[a simple script] (https://github.com/emezeske/lein-cljsbuild/blob/0.1.3/example-projects/advanced/phantom/unit-test.js)
